...
Le vin, une question de bon(s) sens !');
        ...
        $book1->setPressTitle(NULL);
        $book1->setPressImageUrl(NULL);
...
Livre historique et passionnant à découvrir, c’est un magnifique cadeau à offrir ou à s’offrir pour Noël ou toutes autres circonstances. Réservez dès à présent votre livre....');
        ...
        $book2->setPressTitle(NULL);
        $book2->setPressImageUrl(NULL);
...
Une seule envie : dévorer ce livre !');
        ...
        $book3->setPressTitle(NULL);
        $book3->setPressImageUrl(NULL);
        ...
        $book4->setPressTitle(NULL);
        $book4->setPressImageUrl(NULL);
        ...
        $book5->setPressTitle(NULL);
        $book5->setPressImageUrl(NULL);
        ...
        $book6->setPressTitle(NULL);
        $book6->setPressImageUrl(NULL);
        ...
        $book7->setPressTitle(NULL);
        $book7->setPressImageUrl(NULL);
        ...
        $book8->setPressTitle(NULL);
        $book8->setPressImageUrl(NULL);
        ...
        $book9->setPressTitle(NULL);
        $book9->setPressImageUrl(NULL);
